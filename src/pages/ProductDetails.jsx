...
const mockProduct = {
  ...
  description:
    "A beautifully crafted Anarkali Kurta Set featuring vibrant prints inspired by Indian heritage. Perfect for casual outings and festive occasions. The flowy silhouette and premium cotton blend ensure all-day comfort while keeping you stylish.",
  highlights: [
  ...
  reviews_list: [
    {
      ...
      rating: 5,
      date: "12 May 2025",
      text: "Absolutely love this kurta! The fabric is so soft and the print is gorgeous. Fits true to size.",
      verified: true,
    },
    {
      name: "Meera S.",
      rating: 4,
      date: "3 Apr 2025",
      text: "Very nice quality. The color is exactly as shown in pictures. Comfortable to wear.",
      verified: true,
    },
    {
      name: "Kavya M.",
      rating: 4,
      date: "18 Mar 2025",
      text: "Good product for the price. The dupatta is beautiful. Will order more.",
      verified: false,
    },
    {
      name: "Divya K.",
      rating: 5,
      date: "2 Feb 2025",
      text: "Perfect festive wear! Got many compliments. Highly recommend.",
      verified: true,
    },
  ],
};
...
const relatedProducts = [
  {
    ...
    mrp: 3499,
    discount: 66,
    img: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=300&h=400&fit=crop",
  },
  {
    id: 3,
...
export default function ProductDetailPage() {
  ...
  return (
    <div style={{ backgroundColor: SURFACE, minHeight: "100vh" }}>
      ...
      <div className="pdp-page" style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 40px" }}>
        <div className="pdp-top-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "start" }}>
          <div className="pdp-gallery" style={{ position: "sticky", top: 80 }}>
            <div
              style={{
                borderRadius: 12,
                overflow: "hidden",
            ...
            >
              ...
              >
                <svg
                  width="20"
                  height="20"
                  fill={wishlisted ? "#ff4d4f" : "none"}
                  stroke={wishlisted ? "#ff4d4f" : "currentColor"}
                  viewBox="0 0 24 24"
                >
                  <path
                    strokeLinecap="round"
          ...
          <div style={{ animation: "slideUp 0.4s ease" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 22 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", border: `1.5px solid ${BORDER}`, borderRadius: 6, overflow: "hidden" }}>
                {["-", "qty", "+"].map((item) =>
                  item === "qty" ? (
                    <span key="qty" style={{ width: 40, textAlign: "center", fontSize: 14, fontWeight: 700, color: CHARCOAL }}>
                      {qty}
                    </span>
                  ) : (
                    <button
                      ...
                      style={{ width: 36, height: 36, border: "none", backgroundColor: "#fff", cursor: "pointer", fontSize: 18, fontWeight: 700, color: GOLD_DARK }}
                    >
                      {item}
                    </button>
                  )
            ...
            <div className="pdp-cta-row" style={{ display: "flex", gap: 12, marginBottom: 24, alignItems: "stretch" }}>
              <button
            ...
            <div className="pdp-trust-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24, padding: 16, backgroundColor: "#fff", borderRadius: 8, border: `1px solid ${BORDER}` }}>
              {[
            ...
            <div>
              ...
              {activeTab === "description" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <p style={{ fontSize: 13, color: MUTED, lineHeight: 1.7, marginBottom: 14 }}>{product.description}</p>
                  <ul style={{ paddingLeft: 0, listStyle: "none" }}>
                    {product.highlights.map((h) => (
                      <li key={h} style={{ display: "flex", alignItems: "flex-start", gap: 8, fontSize: 13, color: CHARCOAL, marginBottom: 8 }}>
              ...
              {activeTab === "reviews" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  ...
                  {product.reviews_list.map((r, idx) => (
                    <div key={idx} style={{ padding: "14px 0", borderBottom: idx < product.reviews_list.length - 1 ? `1px solid ${BORDER}` : "none" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                        ...
                        <div>
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            ...
                            {r.verified && (
                              <span style={{ fontSize: 9, color: GREEN, fontWeight: 600, backgroundColor: "#E8F5E9", padding: "1px 6px", borderRadius: 10 }}>
                                ✓ Verified
                              </span>
                            )}
                          </div>
        ...
        <div className="pdp-related-section" style={{ marginTop: 60, borderTop: `1px solid ${BORDER}`, paddingTop: 40 }}>
          ...
          <div className="pdp-related-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
