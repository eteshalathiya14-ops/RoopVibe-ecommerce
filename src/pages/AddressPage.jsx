...
export default function AddressPage() {
  ...
  // rv-addr-input class use karo taaki Mobile.css override na kare
        ...
        <div style={{ minHeight: 'calc(100vh - 128px)', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: SURFACE, fontFamily: "'DM Sans', sans-serif", padding: isMobile ? '24px 16px' : '0' }}>
          <div style={{ textAlign: 'center', animation: 'fadeUp 0.5s ease' }}>
            ...
            <div style={{ backgroundColor: '#fff', padding: '20px 32px', borderRadius: '12px', border: `1px solid ${BORDER}`, display: 'inline-block', marginBottom: '32px' }}>
              ...
              <p style={{ fontSize: '18px', fontWeight: '800', color: CHARCOAL }}>#RV{Math.floor(Math.random() * 900000 + 100000)}</p>
            </div>
            <div>
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Address inputs — Mobile.css ke global override se bachane ke liye */
        .rv-addr-input {
            ...
            {step === 1 && (
              <div className="section-card" style={{ backgroundColor: '#fff', borderRadius: '12px', border: `1px solid ${BORDER}`, overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
                ...
                <div style={{ padding: isMobile ? '20px 16px' : '28px' }}>
                  ...
                  <button onClick={() => { try { localStorage.setItem("rv_saved_address", JSON.stringify(formData)); } catch {} setSavedAddress(formData); setStep(2); }} className="proceed-btn"
...
function renderPaymentPanel({ paymentMethod, cardData, setCardData, upiId, setUpiId, banks, finalTotal, focusedField, setFocusedField, plainInput, GOLD, GOLD_DARK, GOLD_LIGHT, GREEN, GREEN_LIGHT, BORDER, CHARCOAL, isMobile }) {
